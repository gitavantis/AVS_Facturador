...
namespace AVSFacturador.Complementos
{
    ...
    {
        public virtual string Serialize(Nomina nomina)
        {
        ...
        public static bool Deserialize(string xml, out Nomina obj, out System.Exception exception)
        {
            ...
            try
            {
                ...
                System.Xml.Serialization.XmlSerializer xmlSerializer = new System.Xml.Serialization.XmlSerializer(typeof(Nomina));
                obj = (Nomina)xmlSerializer.Deserialize(xmlTextReader);
                return true;
            }
        ...
        public Nomina Deserialize(string xml)
        {
            System.Exception e;
            Nomina nomina;
