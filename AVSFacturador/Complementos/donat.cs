...
namespace AVSFacturador.Complementos {
    ...
    {
        public virtual string Serialize(Donatarias donatarias)
        {
            ...
            xmlSerializer.Serialize(memoryStream, donatarias, ns);
            memoryStream.Seek(0, System.IO.SeekOrigin.Begin);
            System.IO.StreamReader streamReader = new System.IO.StreamReader(memoryStream);
            return streamReader.ReadToEnd();
        }

        public static bool Deserialize(string xml, out Donatarias obj, out System.Exception exception)
        {
            exception = null;
            obj = null;
            try
            {
                ...
                System.Xml.Serialization.XmlSerializer xmlSerializer = new System.Xml.Serialization.XmlSerializer(typeof(Donatarias));
                obj = (Donatarias)xmlSerializer.Deserialize(xmlTextReader);
                return true;
            }
        ...
        public Donatarias Deserialize(string xml)
        {
            System.Exception e;
            Donatarias donatarias;
            if (Deserialize(xml, out donatarias, out e))
            {
                return donatarias;
            }
            else
