...
namespace AVSFacturador.Complementos.Nomina12
{
    ...
    [System.Xml.Serialization.XmlRootAttribute(ElementName = "Nomina", Namespace = "http://www.sat.gob.mx/nomina12", IsNullable = false)]
    public partial class Nomina12
    {

        public virtual string Serialize(Nomina12 nomina)
        {
            ...
            xmlSerializer.Serialize(memoryStream, nomina, ns);
            memoryStream.Seek(0, System.IO.SeekOrigin.Begin);
            System.IO.StreamReader streamReader = new System.IO.StreamReader(memoryStream);
            return streamReader.ReadToEnd();
        }

        public static bool Deserialize(string xml, out Nomina12 obj, out System.Exception exception)
        {
            exception = null;
            obj = null;
            try
            {
                ...
                System.Xml.Serialization.XmlSerializer xmlSerializer = new System.Xml.Serialization.XmlSerializer(typeof(Nomina12));
                obj = (Nomina12)xmlSerializer.Deserialize(xmlTextReader);
                return true;
            }
        ...
        public Nomina12 Deserialize(string xml)
        {
            System.Exception e;
            Nomina12 nomina;
            if (Deserialize(xml, out nomina, out e))
            {
                return nomina;
            }
            else
